# rev38 Templating + Dryer Risk Morris Summary
...
_Non-zero only for surface_weld (type 3) and minimally for capillary_bridge (type 4)._

**rigid**: zero (no liquid template or immiscible).

**gas**: zero (no liquid template or immiscible).

**surface_weld**: D_particle(1.00,lin), tau(0.87,lin), C_plasticizer(0.32,lin), Q_template(0.30,lin), C_monomer(0.27,lin), Q_colloid(0.17,cplx) 

**capillary_bridge**: template_dose(1.00,lin), D_particle(0.41,lin), tau(0.39,cplx), Q_template(0.15,cplx), C_plasticizer(0.14,lin), C_monomer(0.13,lin) 
