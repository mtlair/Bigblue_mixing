...
- `D_template` decouples porosity control from dryer process noise (unlike `D_b` or `alpha_g_0`)
...
- ✅ Emulsion factors show regime structure:
  ...
  - `D_template` controls `D_pore` almost exclusively (~9.3), decoupling pore size from dryer process
