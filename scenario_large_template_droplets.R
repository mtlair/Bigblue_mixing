...
cat("  Larger template droplets in the primary atomizer still end up as pores, not\n")
...
cat("  would require coupling the template droplet size through atomizer dynamics\n")
